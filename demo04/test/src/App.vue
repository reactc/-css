  ...
  <main class="app">
    ...
    <section class="create-todo">
      ...
      <form @submit.prevent="addTodo">
        <h4>在这里输入你的待办事项</h4>
        <input type="text" placeholder="示例：制作一条短视频！" v-model="input_content">
    ...
    <section class="todo-list">
      <h3>待办事项</h3>
      <div class="list">
        <div v-for="todo in todos" :key="todo.index" :class="`todo-item ${todo.done && 'done'}`">
          <label>
...
export default {
  ...
  methods: {
    addTodo() {
      if (this.input_content.trim() === '' || this.input_category.value === null) {
        return
      } else {
        this.todos.push({
